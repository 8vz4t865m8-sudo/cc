//
//  iphook.m - KFun 真卡密记录版 v3-fix (闪退修复)
//  去掉了：hookDelays(performSelector:afterDelay) + hookAllActivationRelated(全类遍历)
//
...
// ============================================================
// 🔔 NSNotificationCenter 监控 (精简版，只监控自定义通知)
// ============================================================
...
static void iphook_init() {
    NSLog(@"========================================");
    NSLog(@"[KFunRecV3] 真卡密增强记录版 v3-fix 已加载");
    NSLog(@"========================================");
